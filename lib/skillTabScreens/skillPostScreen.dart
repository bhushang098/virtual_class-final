...
class _SkillPostScreenState extends State<SkillPostScreen> {
            ...
            if (members.containsKey(user.uid) ||
              ...
              showDialog(
                  ...
                  child: Dialog(
                    ...
                    child: Text('Only Members Can post In This Skill'),
                  )));
            }
          }
        },
                                                    ...
                                                    child: Dialog(
                                                      ...
                                                      padding:
                                                          const EdgeInsets.all(
                                                              15.0),
                                                      child: Text(
                                                          'Only Members Can Comment In This Skill'),
                                                    )));
                                              }
                                            }
                                          },
  ...
  void getsettings(String skilld) async {
    DocumentSnapshot snp =
        await Firestore.instance.collection('skills').document(skilld).get();
