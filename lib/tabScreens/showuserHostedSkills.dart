...
class ShowuserHostedSkills extends StatefulWidget {
  ShowuserHostedSkills({Key key, this.hostedSkillList}) : super(key: key);

  var hostedSkillList;
  @override
  _ShowuserHostedSkillsState createState() => _ShowuserHostedSkillsState();
}

class _ShowuserHostedSkillsState extends State<ShowuserHostedSkills> {
