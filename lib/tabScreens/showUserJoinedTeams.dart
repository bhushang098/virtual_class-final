...
class ShowUserJoinedTeams extends StatefulWidget {
  ShowUserJoinedTeams({Key key, this.joinedTeamList}) : super(key: key);

  var joinedTeamList;
  @override
  _ShowUserJoinedTeamsState createState() => _ShowUserJoinedTeamsState();
}

class _ShowUserJoinedTeamsState extends State<ShowUserJoinedTeams> {
