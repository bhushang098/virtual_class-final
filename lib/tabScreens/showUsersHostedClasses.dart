...
class ShowUserHostedClasses extends StatefulWidget {
  ShowUserHostedClasses({Key key, this.hostedClassList}) : super(key: key);

  var hostedClassList;
  @override
  _ShowUserHostedClassesState createState() => _ShowUserHostedClassesState();
}

class _ShowUserHostedClassesState extends State<ShowUserHostedClasses> {
